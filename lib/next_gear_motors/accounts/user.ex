defmodule NextGearMotors.Accounts.User do
  @moduledoc """
  # User Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, NextGearMotors.Repo)
  ...
  """
  def valid_password?(%NextGearMotors.Accounts.User{hashed_password: hashed_password}, password)
