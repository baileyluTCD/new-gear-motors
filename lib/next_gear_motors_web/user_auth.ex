defmodule NextGearMotorsWeb.UserAuth do
  @moduledoc """
  # User Auth Module
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_next_gear_motors_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      NextGearMotorsWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule NextGearMotorsWeb.PageLive do
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{NextGearMotorsWeb.UserAuth, :ensure_authenticated}] do
