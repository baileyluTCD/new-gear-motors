defmodule NextGearMotorsWeb.CoreComponents do
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NextGearMotorsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NextGearMotorsWeb.Gettext, "errors", msg, opts)
    end
  end
