defmodule NextGearMotorsWeb.Components.Image do
  @moduledoc """
  The `NextGearMotorsWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
