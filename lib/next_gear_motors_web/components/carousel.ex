defmodule NextGearMotorsWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `NextGearMotorsWeb.Components.Carousel`
  project.
  ...
  import NextGearMotorsWeb.Components.Image, only: [image: 1]
  import Phoenix.LiveView.Utils, only: [random_id: 0]
  import NextGearMotorsWeb.Components.Icon, only: [icon: 1]
  use Gettext, backend: NextGearMotorsWeb.Gettext
